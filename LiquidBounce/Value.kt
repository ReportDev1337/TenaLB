...
import net.ccbluex.liquidbounce.utils.flux.Translate
...
open class DoubleValue(name: String, value: Double, val minimum: Double = 0.0, val maximum: Double = Double.MAX_VALUE, val suffix: String, displayable: () -> Boolean)
    : Value<Double>(name, value, displayable) {
    val translate = Translate(0F, 0F)

    constructor(name: String, value: Double, minimum: Double, maximum: Double, displayable: () -> Boolean): this(name, value, minimum, maximum, "", displayable)
    constructor(name: String, value: Double, minimum: Double, maximum: Double, suffix: String): this(name, value, minimum, maximum, suffix, { true } )
...
//    override fun canSetIf(check: (Float) -> Boolean): DoubleValue {
//        this.canSet = check
//        return this
//    }
