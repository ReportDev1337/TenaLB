...
object RotationUtils : MinecraftInstance(), Listenable {
    ...
    fun faceLook(target: Entity, minTurnSpeed: Float, maxTurnSpeed: Float) {
        val player = mc.thePlayer
        val posX: Double = target.posX + 0.toDouble() - player.posX
        val posY: Double = target.entityBoundingBox.minY + target.eyeHeight - 0.15 - player.entityBoundingBox.minY - player.getEyeHeight()
        val posZ: Double = target.posZ + 0.toDouble() - player.posZ
