...
@ModuleInfo(name = "Fly", description = "Allows you to fly in survival mode.", category = ModuleCategory.MOVEMENT, keyBind = Keyboard.KEY_G)
        ...
        switch (mode.toLowerCase()) {
            ...
            case "watchdog":
                ...
                if (expectItemStack == -1) {
                    ...
                    NotificationManager.addNotification("The Fly requires Slime Blocks to be Activated properly", Notification.Type.ERROR);
                    break;
                }
        ...
        switch (modeValue.get().toLowerCase()) {
            ...
            case "pearl":
                ...
                if (pearlState == 0) {
                    if (enderPearlSlot == -1) {
                        new SoundFxPlayer().playSound(SoundFxPlayer.SoundType.VICTORY, -8f);
                        NotificationManager.addNotification("You Don't Have Any EnderPearl", Notification.Type.ERROR);
                        pearlState = -1;
                        this.setState(false);
                        return;
                    }
