...
public final class MovementUtils extends MinecraftInstance {
    ...
    public final void jump(MoveEvent event) {
        double jumpY = (double)mc.thePlayer.jumpMovementFactor;
    ...
    public static void setMotionLiquidSense(MoveEvent e, double speed) {
    ...
    public static void setMotion2(MoveEvent event, double speed, double motion) {
        double forward = mc.thePlayer.movementInput.moveForward;
        double strafe = mc.thePlayer.movementInput.moveStrafe;
        double yaw = mc.thePlayer.rotationYaw;
